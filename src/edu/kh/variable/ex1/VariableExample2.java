...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		boolean booleanDate;
		//메모리에 논리값(t/f)을 저장할 공간 1byte 할당하고 
		 ...
		 * 선언된 byteNumber 변수에 처음으로 127울 넣음.
		 * ==> 초기화 : 처음 변수에 값을 대입
		 * 정수 -128~127 까지 1byte 범위임
		 */
		...
		// 정수자료형의 기본형 (short byte 옛날 코드의 잔재 잘안씀)
		
		int intNumber = 214748364; //변수 선언 및 초기화
		// 자료형 변수명 = 리터럴;
		...
		long longNumber = 10000000000L; //소문자 대문자 상관X
		// The literal 10000000000 of type int is out of range
		// 100억 이라는 값은 범위를 벗어남
		// 뒤에 L을 붙여줌으로써 long 자료형인것을 나타내야함
		
		
		// 실수형
		float floatNumber = 1.2345f; //F,f 안가림
		...
		char ch = 'A'; //65
		char ch2 = 66; //B
		// String str = 'gdsg'; <= String 에선 항상 " " 써야함
		
		System.out.println("ch2" + ch2);
		/* char 자료형에 숫자가 대입될 수 있는 이유
		 * - 컴퓨터에는 문자표가 존재하고
		 * 숫자에 따라 지정된 문자 모양이 매핑되어있고
		 * 예를들어 'B' 문자 그대로가 대입되면 변수에 숫자 66으로 변환되서 저장
		...
		// 5. 특수문자는 _, $ 만 사용가능(하지만 쓰지않음)
		
		int $intNumber; // 문제는 없지만 개발자가 직법 사용 안함.
		int int_number; // 자바는 카멜표기법 쓰기때문에 _ 사용 안함
						// _ 작성표기법은 DB에서 사용
		
		// 6. 카멜표기법
		// -> 변수명 작정시 여러단어를 이어서 작성하는 경우
		// 	  띄어쓰지 않고 후속단어 첫글자를 대문자로 작성
		char helloWorldApp;
		
		// 7. 변수명은 언어를 가리지 않음(하지만 사용하지 않음)
		int 정수1 = 10;
